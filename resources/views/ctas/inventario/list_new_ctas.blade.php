<div class="container">
    ...
    <div class="collapse" id="collapseExample">
        ...
        <p>Listado de cuentas generadas después del corte. 
            Únicas: 
            <span data-placement="center" title="Cuentas únicas" class="small badge-pill badge-success">
                {{ str_pad($solicitudes->count(), 2, '0', STR_PAD_LEFT) }}
            </span>

            En los 3 CIZs:
            <span data-placement="center" title="Total de cuentas" class="badge-pill badge-success small">
