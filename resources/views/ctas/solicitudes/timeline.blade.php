                ...
                <div class="card-body border-light">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            ...
                            <div>
                                {{ $datos_timeline->movimiento->name }} - {{ $cuenta }} ({{ isset($datos_timeline->gpo_actual) ? $datos_timeline->gpo_actual->name : '' }} {{ isset($datos_timeline->gpo_nuevo) ? ' -> ' . $datos_timeline->gpo_nuevo->name : '' }})
                        ...
                        @if( isset($datos_timeline->valija) )
                            ...
                            <li class="list-group-item">
                                <div>
                                    ...
                                    <div>
                                        Núm. gestión CA: {{ $datos_timeline->valija->num_oficio_ca }}
                                    </div>
                                </div>
                                <div>
