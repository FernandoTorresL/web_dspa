...
@section('content')
    ...
    <form action="valijas/createNC" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="container">
            <br>
            <div class="row">
                <div class="col-sm-10">
                    <div class="form-group">
                        <label for="archivo">PDF de la Valija</label>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_recepcion_ca" class="form-control @if($errors->has('fecha_recepcion_ca')) is-invalid @endif" value="{{ old('fecha_recepcion_ca') }}">
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <div class="input-group mb-4">
                        <input type="text" name="num_oficio_del" class="form-control @if($errors->has('num_oficio_del')) is-invalid @endif" value="{{ old('num_oficio_del') }}">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_valija_del" class="form-control @if($errors->has('fecha_valija_del')) is-invalid @endif" value="{{ old('fecha_valija_del') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @if($errors->has('delegacion')) is-invalid @endif" id="delegacion" name="delegacion">
                            ...
                            @forelse($delegaciones as $del)
                                @php
                                    $del->id == old('delegacion') ? $str_check = 'selected' : $str_check = '';
                                @endphp
            ...
            <div class="input-group text-right">
                <button type="submit" class="btn btn-primary">Crear Valija</button>
            </div>
        </div>
    </form>
    <br>
