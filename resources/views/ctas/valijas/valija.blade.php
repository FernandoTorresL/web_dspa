...
<div class="card border-info">
    <div class="card-header">
        ...
        <h4 class="card-title">
            {{--Fecha de recepción en Área de Gestión:--}}
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        <span class="card-text float-right @if(isset($valija->rechazo)) text-success @else text-info @endif">
                            {{ isset($valija->rechazo) ? 'Abierta' : 'Cerrada' }}
                        </span>
                        <div>
            ...
            <div class="card-body border-light">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        ...
                        <div>
                            <strong>Fecha de captura: </strong><span class="card-text float-right">{{ $valija->created_at }}</span>
                        </div>
                    </li>
