    @if(count($solicitudes_con_respuesta_mainframe_error))
        <h5 class="text-danger">Total de solicitudes con rechazo en Mainframe: {{ $solicitudes_con_respuesta_mainframe_error->count() }}</h5>
    ...
    @forelse( $solicitudes_con_respuesta_mainframe_error as $row_tabla_mov )
        @php
